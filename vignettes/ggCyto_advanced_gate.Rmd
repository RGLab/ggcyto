...
# add stats
stats <- compute_stats.percent(fs, poly.gates)# calculate cell % and ccentroid of the gates
...
# add stats
stats <- compute_stats.percent(fs, den.gates)# calculate cell % and ccentroid of the gates
